...
• Experimental concept with potential for precise control`,
  ...
  const allTopics = Object.values(educationalSections).flatMap(section => 
    section.topics.map(topic => ({ ...topic, sectionColor: section.color }))
  );
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <Button 
                        ...
                        onClick={() => {
                          ...
                          const tabTrigger = document.querySelector(`[value="${key}"]`) as HTMLElement;
                          tabTrigger?.click();
                        }}
                      >
